...
$packageArgs = @{
  ...
  url64bit       = 'https://github.com/topgrade-rs/topgrade/releases/download/v17.2.0/topgrade-v17.2.0-x86_64-pc-windows-msvc.zip'
  checksum64     = 'e6e4e1d2d52fbe2a599e06da8ac5a80eccd139d83cb05798d1bed9a1a9863094'
