...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url            = 'https://download.microsoft.com/download/6c1eeb25-cf8b-41d9-8d0d-cc1dbc032140/officedeploymenttool_20131-20090.exe'
    checksum       = 'fa6cbe5b383f89b83f373c36c90ebdcc9acffa43d0cb47fb69062c41f46c0769'
    checksumType   = 'sha256'
