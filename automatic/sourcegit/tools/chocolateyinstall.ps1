...
$packageArgs = @{
  ...
  url64bit       = 'https://github.com/sourcegit-scm/sourcegit/releases/download/v2025.02/sourcegit_2025.02.win-x64.zip'
  checksum64     = 'dc8af44d0cf720838e32fb5e104314775152afd55fef8a7172547ce7fe552d84'
