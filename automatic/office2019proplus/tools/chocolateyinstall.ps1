...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url            = 'https://download.microsoft.com/download/6c1eeb25-cf8b-41d9-8d0d-cc1dbc032140/officedeploymenttool_19822-20114.exe'
    checksum       = '9a9e0e041a4f0a9465692e5df3229715d400f850a8f363ea1b00918ac1cdb648'
    checksumType   = 'sha256'
