...
$url64 = 'https://github.com/ollm/OpenComic/releases/download/v1.0.0/OpenComic.Setup.1.0.0.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName   = 'opencomic*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
