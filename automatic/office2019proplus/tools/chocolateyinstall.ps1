...
$packageArgs = @{
    ...
    fileType       = 'exe'
    url            = 'https://download.microsoft.com/download/6c1eeb25-cf8b-41d9-8d0d-cc1dbc032140/officedeploymenttool_19328-20210.exe'
    checksum       = '2e55a704e38acca3e2575f1a52b4afb561508d58f1422586cb4d9aa283fcb12b'
    checksumType   = 'sha256'
